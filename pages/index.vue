      ...
      <div class="preview-container">
        <nuxt-link to="/error">
          <div class="preview-image theme-box">
            ...
            <div class="view-box">
              ...
              <div class="view-numbers">{{ successPosts[0].view }}</div>
            </div>
            <div class="theme"></div>
          </div>
        </nuxt-link>
          ...
          <nuxt-link to="/error">
            <div class="preview-image-mini">
              ...
              <div class="view-box view-box-mini">
                ...
                <div class="view-numbers">{{ successPosts[1].view }}</div>
              </div>
              <div class="theme"></div>
            </div>
          </nuxt-link>
          <nuxt-link to="/error">
            <div class="preview-image-mini">
              ...
              <div class="view-box view-box-mini">
                ...
                <div class="view-numbers">{{ successPosts[2].view }}</div>
              </div>
              <div class="theme"></div>
            </div>
          </nuxt-link>
        ...
        <div class="bar">
          ...
          <div class="lists-container">
            <nuxt-link to="/error">
              <div class="bar-list">Мы с моей командой смотрим </div>
            </nuxt-link>
            <nuxt-link to="/error">
              <div class="bar-list">Немного магии Hytale в вашу ленту❄ </div>
            </nuxt-link>
          </div>
        </div>
      </div>
